...
def largest_product(grid, adjacent_count):
    rows = len(grid)
    cols = len(grid[0])
    largest_product = 0
    ...
    for row in range(rows):
        for col in range(cols - adjacent_count + 1):
            product = 1
    ...
    for row in range(rows - adjacent_count + 1):
    ...
    for row in range(adjacent_count - 1, rows):
        for col in range(cols - adjacent_count + 1):
            product = 1
            for i in range(adjacent_count):
                product *= grid[row - i][col + i]
